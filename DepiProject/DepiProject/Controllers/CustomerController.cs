...
public class CustomerController : Controller
{
    ...
    public async Task<IActionResult> Cart()
    {
        ...
        {
            ShoppingCart = new List<DepiProject.Models.ShoppingCart>
            {
                new DepiProject.Models.ShoppingCart
                {
                    Id = 1,
                    Name = "UltraPhone 12 Pro",
                    ...
                    Price = 999.99,
                    Count = 1,
                    Image = "/images/products/ultraphone.jpg"
                },
                new DepiProject.Models.ShoppingCart
                {
                    Id = 2,
            ...
            TotalPrice = 999.99 + (149.99 * 2) // = 1299.97
        };
